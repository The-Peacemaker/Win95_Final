...
<div :id="window.windowId" :style="style" class="window window-style" :class="{
    ...
    <form @submit="sendEmail" action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSd1VGfIJytEIIcfFz75P_2B_IpBcyCEKO4bPQO1SS0l4GQUOw/formResponse" class="window-style" id="container" target="hidden_iframe">
        ...
        <div class="content">
            <div class="container-details">
                ...
                <div class="subject-container">
                    ...
                    <div class="receipient">Benedict</div>
                </div>
                <hr />
                <div class="subject-container">
                    <p style="margin: 8px">Subject:</p>
                    <input name="entry.257900800" class="subject" v-model="mailSubject" v-on:input="onChangeMailSubject" type="text" required="true" />
                </div>
                <hr />
                <div class="from-container" style="margin-bottom: 2px">
                    <p style="margin: 8px">From:</p>
                    <input name="entry.1637310755" class="subject" v-model="mailSender" v-on:input="onChangeMailSender" type="email" required="true" />
                </div>
            </div>

            <textarea name="entry.2141632832" v-model="mailContent" v-on:input="onChangeMailContent" required="true"></textarea>
        </div>
    </form>
</div>
</template>
