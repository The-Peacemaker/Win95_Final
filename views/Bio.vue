<template>
<div>
    <img class="w-auto h-auto" src="@/assets/Biography/self.jpg" />
    ...
    <div class="pt-7">
        ...
        <p class="font-thin text-sm pb-2.5">
            I’m a {{ new Date().getFullYear() - 2005 }} year old engineering student who's currently pursuing BTech Degree in Computer Science and Engineering From Viswajyothi College Of Engineering And Technology, Vazhakulam.
        </p>
        <p class="font-thin text-sm pb-2.5">
            I am a passionate developer , bug bounty hunter and a tech enthusiast. I have a keen interest in web development, mobile app development, and cybersecurity. I am always eager to learn new technologies and improve my skills.
        </p>
        <p class="font-thin text-sm pb-2.5">
            I have experience in various programming languages and frameworks, including Python, JavaScript, React Native, Vue.js, and more. I am also familiar with tools like Burp Suite, Metasploit, and Nmap.
        </p>
        <p class="font-thin text-sm pb-2.5">
            I enjoy finding vulnerabilities in web applications and reporting them to the respective organizations. I have participated in various CTF competitions and have a good understanding of web application security.
        </p>
        <p class="font-thin text-sm pb-2.5">
            I have experiences in working in various cybersecurity projects and have contributed to open-source projects. I am always looking for opportunities to work on interesting projects and collaborate with like-minded individuals.
        </p>
    </div>
...
<!--
    ...
    <div class="pt-7">
        ...
        <div class="">
            <h3 class="pb-1"><b>project name</b></h3>
            <h6 class="text-gray-600 font-medium text-xs">short detail</h6>
            <p class="font-thin text-sm pb-2.5">
                details
